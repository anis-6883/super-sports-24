...
<form class="ajax-submit2" method="post" autocomplete="off" action="{{ route('subscriptions.update', $subscription->id) }}" enctype="multipart/form-data">
	@csrf
	@method('PUT')
	<div class="row">
		<div class="col-md-6">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<select class="form-control select2" name="app_id" data-selected="{{ $subscription->app_id }}" required>
									<option value="">{{ _lang('Select One') }}</option>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<select class="form-control select2" name="status" data-selected="{{ $subscription->status }}" required>
