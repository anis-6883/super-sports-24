...
<form method="post" class="ajax-submit2" autocomplete="off" action="{{ route('live_matches.update', $live_match->id) }}" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-12">
